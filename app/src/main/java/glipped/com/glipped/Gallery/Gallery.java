package glipped.com.glipped.Gallery;
...
public class Gallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            Window window = Gallery.this.getWindow();
            window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            window.setStatusBarColor(Gallery.this.getResources()
    ...
    public void setupLeftDrawer() {
        ...
        LeftDrawer leftDrawer = new LeftDrawer(leftDrawerToggle, leftDrawerLayout, Gallery.this);
